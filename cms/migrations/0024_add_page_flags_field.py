...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Page.page_flags'
        db.add_column('cms_page', 'page_flags', orm['cms.page:page_flags'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Page.page_flags'
        db.delete_column('cms_page', 'page_flags')
